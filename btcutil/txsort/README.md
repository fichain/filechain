...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/filechain/filechain/btcutil/txsort)
...
```bash
$ go get -u github.com/filechain/filechain/btcutil/txsort
```
