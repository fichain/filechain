...
func TestOpcodeDisasm(t *testing.T) {
	...
	for opcodeVal, expectedStr := range expectedStrings {
		...
		case opcodeVal >= 0xb0 && opcodeVal <= 0xbf:
			switch opcodeVal {
			case 0xb1:
			...
			case 0xba:
				expectedStr = "OP_FILE_PUBLISH"
			case 0xbb:
				expectedStr = "OP_FILE_BUY_PAY"
			case 0xbc:
				expectedStr = "OP_FILE_BUY_TRANS"
			case 0xbd:
				expectedStr = "OP_FILE_CONFIRM_BUY"
			case 0xbe:
				expectedStr = "OP_FILE_CONFIRM_TRANSFEE"
			case 0xbf:
				expectedStr = "OP_FILE_APPEAL_TRANSFEE"
			default:
		...
		// OP_UNKNOWN#.
		case opcodeVal >= 0xc0 && opcodeVal <= 0xf9 || opcodeVal == 0xfc:
