...
var helpDescsEnUS = map[string]string{
	...
	"filehashinforsp-isoriginal":           "是否原创内容",
	"filehashinforsp-isviolence":           "是否包含暴力内容",
	"buyhashinforsp-finaltransfees":        "最终传输费用",
	"filehashinforsp-ispolitically":        "是否包含政治相关内容",
	"filehashinforsp-issexually":           "是否包含性相关内容",
	"buyhashinforsp-finaltransfees--desc":  "最终确认的传输费用，如果没人反对，则押金会被取回",
	"buyhashinforsp-finaltransfees--value": "是一个对象，包含最终传输确认信息",
	"buyhashinforsp-finaltransfees--key":   "这是什么鬼",
	"buyhashinforsp-transfeetx":            "押金事务的交易号",
	"buyhashinforsp-transfeevoutidx":       "押金事务的vout索引",
	"filehashinforsp-lastsucctime":         "最后下载成功的时间",
	"buyhashinforsp-transfee":              "购买者愿意承担的总传输费",
	"filehashinforsp-downloadfail":         "文件下载失败次数",
	"filehashinforsp-downloadsucc":         "文件下载成功次数",
	"buyhashinforsp-filehash":              "文件哈希",
	"buyhashinforsp-buyhash":               "购买哈希",
	"filehashinforsp-author":               "作者收钱地址",
	"buyhashinforsp-blockheight":           "块高度",
	"filehashinforsp-price":                "作者定义的价钱",
	"listfilehash-offset":                  "偏移，从第几个开始枚举",
	"filehashinforsp-title":                "作者指定的文件标题",
	"getbuyhashinfo-hash":                  "购买哈希",
	"listfilehash-limit":                   "限制返回的数量",
	"getbuyhashinfo--synopsis":             "获取某次购买的详细信息",
	"listfilehash--synopsis":               "列举所有已经分享的文件信息",
	"filehashinforsp-hash":                 "文件分享哈希",
	"filehashinforsp-blockheight":          "分享操作所在的块高度",
	"getfilehashinfo-hash":                 "要获取的文件哈希",
	"getfilehashinfo--synopsis":            "通过hash获取某个文件的信息",
	"buyhashinforsp-depositvalueleft":      "还剩多少押金作为传输押金",
	"buyhashinforsp-buyer":                 "购买者地址，证明需要由这个地址签名",
}
...
var rpcResultTypes = map[string][]interface{}{
	...
	"getbuyhashinfo":  {(*btcjson.BuyHashInfoRsp)(nil)},
	"listfilehash":    {(*btcjson.BuyHashInfoRsp)(nil)},
	"getfilehashinfo": {(*btcjson.FileHashInfoRsp)(nil)},
}
