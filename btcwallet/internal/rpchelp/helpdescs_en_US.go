...
var helpDescsEnUS = map[string]string{
	...
	"confirmbuy--result0":                  "返回事务哈希",
	"transfeereq-fee":                      "传输费用",
	"transfeereq-account":                  "传输账户，字符串形式的地址",
	"confirmbuy-fees":                      "费用列表",
	"confirmbuy-hash":                      "购买哈希",
	"confirmbuy--synopsis":                 "确认购买",
	"appealtransfee--result0":              "申诉结果",
	"appealtransfee-proof":                 "申诉证据",
	"appealtransfee--synopsis":             "传输费申诉",
	"listhashresult-result":                "列举所有文件",
	"filehashinforsp-isoriginal":           "是否原创",
	"filehashinforsp-isviolence":           "是否涉及暴力内容",
	"filehashinforsp-ispolitically":        "是否涉及政治内容",
	"filehashinforsp-issexually":           "是否涉及性内容",
	"filehashinforsp-lastsucctime":         "上次成功下载时间",
	"filehashinforsp-downloadfail":         "下载失败次数",
	"filehashinforsp-downloadsucc":         "下载成功次数",
	"filehashinforsp-author":               "文件上传者钱包地址",
	"filehashinforsp-price":                "文件定价",
	"filehashinforsp-title":                "文件标题",
	"filehashinforsp-hash":                 "文件哈希",
	"filehashinforsp-blockheight":          "文件信息所在块的高度",
	"listhashresult-total":                 "文件总数",
	"listfilehash-offset":                  "从第几个文件开始返回",
	"listfilehash-limit":                   "一共返回多少个文件信息",
	"listfilehash--synopsis":               "查询文件列表",
	"getfilehashinfo-hash":                 "文件哈希",
	"getfilehashinfo--synopsis":            "通过哈希获取文件基本信息",
	"buyhashinforsp-finaltransfees":        "最终传输费用",
	"buyhashinforsp-finaltransfees--desc":  "最终传输费用清单",
	"buyhashinforsp-finaltransfees--value": "最终传输费用值",
	"buyhashinforsp-finaltransfees--key":   "最终传输费用传输者",
	"buyhashinforsp-transfeevoutidx":       "传输押金所在的 vout索引",
	"buyhashinforsp-transfeetx":            "传输费押金事务的哈希",
	"buyhashinforsp-transfee":              "购买者愿意出的传输费",
	"buyhashinforsp-filehash":              "文件哈希",
	"buyhashinforsp-buyhash":               "购买哈希",
	"buyhashinforsp-blockheight":           "购买信息所在的块高度",
	"getbuyhashinfo-hash":                  "购买哈希",
	"getbuyhashinfo--synopsis":             "通过购买哈希获取购买信息",
	"getproof--result0":                    "获取传输证明",
	"getproof-account":                     "通过哪个账户签署证明",
	"getproof-amount":                      "要证明多少费用",
	"getproof-transfer":                    "要给谁签发证明",
	"getproof-buyhash":                     "给哪次购买签发证明",
	"getproof--synopsis":                   "给传输者生成传输证明",
	"publishhash--result0":                 "发布一个作品",
	"publishhash-authoraddr":               "作者的钱包地址",
	"publishhash-isoriginal":               "是否原创",
	"publishhash-isviolence":               "是否涉及暴力内容",
	"publishhash-ispolitically":            "是否涉及政治内容",
	"publishhash-issexually":               "是否涉及性内容",
	"publishhash-title":                    "发布文件标题",
	"publishhash-price":                    "文件价格",
	"publishhash-hash":                     "文件内容哈希",
	"publishhash--synopsis":                "发布一个文件",
	"buyhash--result0":                     "购买事务的哈希",
	"buyhash-transfee":                     "购买者传输费",
	"buyhash-hash":                         "购买哈希",
	"buyhash--synopsis":                    "购买一个文件内容",
	"buyhashinforsp-buyer":                 "购买者地址，证明内容必须由这个地址签名",
	"buyhashinforsp-depositvalueleft":      "押金在确认购买之后还剩余多少，将作为传输押金",
}
