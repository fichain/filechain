...
can be found [here](https://github.com/filechain/filechain). An alternative
...
https://github.com/filechain/filechain/releases

https://github.com/filechain/filechain/btcwallet/releases
...
```bash
$ cd $GOPATH/src/github.com/filechain/filechain/btcwallet
...
```bash
$ cp $GOPATH/src/github.com/filechain/filechain/sample-btcd.conf ~/.btcd/btcd.conf
$ cp $GOPATH/src/github.com/filechain/filechain/btcwallet/sample-btcwallet.conf ~/.btcwallet/btcwallet.conf
...
The [integrated github issue tracker](https://github.com/filechain/filechain/btcwallet/issues)
