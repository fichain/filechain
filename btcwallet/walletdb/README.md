...
[![GoDoc](https://godoc.org/github.com/filechain/filechain/btcwallet/walletdb?status.png)]
(http://godoc.org/github.com/filechain/filechain/btcwallet/walletdb)
...
http://localhost:6060/pkg/github.com/filechain/filechain/btcwallet/walletdb

## Installation

```bash
$ go get github.com/filechain/filechain/btcwallet/walletdb
```

## Examples

- [Basic Usage Example]
  (http://godoc.org/github.com/filechain/filechain/btcwallet/walletdb#example-package--BasicUsage)  
