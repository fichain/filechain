...
func TestTestNet3GenesisBlock(t *testing.T) {
	...
	for i := 0; i < len(buf.Bytes()); i++ {
		if buf.Bytes()[i] != testNet3GenesisBlockBytes[i] {
			fmt.Printf("不想等 %X %X vs %X\n", i, buf.Bytes()[i], testNet3GenesisBlockBytes[i])
		}
	}
...
var testNet3GenesisBlockBytes = []byte{
	...
	0x67, 0x76, 0x8f, 0x61, 0x7f, 0xc8, 0x1b, 0xc3, /* |gv.a....| */
	0x88, 0x8a, 0x51, 0x32, 0x3a, 0x9f, 0xb8, 0xaa, /* |..Q2:...| */
	0x4b, 0x1e, 0x5e, 0x4a, 0x45, 0x1a, 0x47, 0x60, /* |K.^J)._I| */
...
var simNetGenesisBlockBytes = []byte{
	...
	0x4b, 0x1e, 0x5e, 0x4a, 0x45, 0x06, 0x86, 0x53, 0xff, 0xff, 0x7f, 0x20, 0x02, 0x00, 0x00, 0x00,
