...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/filechain/filechain/integration/rpctest)
...
```bash
$ go get -u github.com/filechain/filechain/integration/rpctest
```
