...
type FutureBuyHashInfoResult chan *response

func (r FutureBuyHashInfoResult) Receive() (*btcjson.BuyHashInfoRsp, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal result as a getinfo result object.
	var infoRes btcjson.BuyHashInfoRsp
	err = json.Unmarshal(res, &infoRes)
	if err != nil {
		return nil, err
	}
...
type FutureFileHashInfoResult chan *response

func (r FutureFileHashInfoResult) Receive() (*btcjson.FileHashInfoRsp, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal result as a getinfo result object.
	var infoRes btcjson.FileHashInfoRsp
	err = json.Unmarshal(res, &infoRes)
	if err != nil {
		return nil, err
	}
...
type FutureListHashResult chan *response

// Receive waits for the response promised by the future and returns the info
// provided by the server.
func (r FutureListHashResult) Receive() (*btcjson.ListHashResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	// Unmarshal result as a getinfo result object.
	var infoRes btcjson.ListHashResult
	err = json.Unmarshal(res, &infoRes)
	if err != nil {
		return nil, err
	}
...
func (c *Client) ListHashAsync(cmd *btcjson.ListHashCmd) FutureListHashResult {
	return c.sendCmd(cmd)
}

func (c *Client) ListHash(cmd *btcjson.ListHashCmd) (*btcjson.ListHashResult, error) {
	return c.ListHashAsync(cmd).Receive()
}

func (c *Client) ListSingleHashAsync(cmd *btcjson.ListSingleHashCmd) FutureFileHashInfoResult {
	return c.sendCmd(cmd)
}

func (c *Client) GetBuyHashInfoAsync(cmd *btcjson.GetBuyHashCmd) FutureBuyHashInfoResult {
	return c.sendCmd(cmd)
}

func (c *Client) GetBuyHashInfo(cmd *btcjson.GetBuyHashCmd) (*btcjson.BuyHashInfoRsp, error) {
	return c.GetBuyHashInfoAsync(cmd).Receive()
}

func (c *Client) ListSingleHash(cmd *btcjson.ListSingleHashCmd) (*btcjson.FileHashInfoRsp, error) {
	return c.ListSingleHashAsync(cmd).Receive()
}
